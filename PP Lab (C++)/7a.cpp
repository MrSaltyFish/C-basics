...
class A {
   public:
    int addfunc(int a, int b, int c) { return a + b + c; }
    double addfunc(double d1, double d2, double d3) { return d1 + d2 + d3; }
    float addfunc(float n1, float n2, float n3) { return n1 + n2 + n3; }
};
int main() {
    A a1;
